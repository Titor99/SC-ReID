...
class GradCam:
    ...
    def __call__(self, x):
        ...
        for i in range(datas.size(0)):
            ...
            for name, module0 in self.model.named_children():
                for name, module in module0.named_children():
                    if name == 'model':
                        feature = module.forward_features(feature)
                    ...
                    if name == 'bottleneck':
                        print('3', feature.size())
                        feature = module(feature)
                    if name == 'classifier':
                        print('4', feature.size())
